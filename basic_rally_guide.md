...
<table>
  ...
  <img src="images_rally_guide/empty_rally.PNG" width="1000" />
...
<table>
  <tr><td> <div style="display: flex; align-items: center;">
  <img src="images_rally_guide/squad_bonus_empty.PNG" width="1000" />
</td><td> <div style="display: flex; align-items: center;">
  <img src="images_rally_guide/hero_skills_empty.PNG" width="1000" />
</td><td> <div style="display: flex; align-items: center;">
  <img src="images_rally_guide/squad_bonus_filled.PNG" width="1000" />
</td><td> <div style="display: flex; align-items: center;">
...
<div style="display: flex; align-items: center;">
  <img src="images_rally_guide/power.PNG" alt="Empty Rally" width="200" />
</div>

<table>
  <tr><td><p>If you scroll down, you'll find the military section with your stats. These stats are applied to all your rallies. Those are smaller than the ones that appeared in the rally squad bonus, because the squad bonus also includes heroes and gear stats. Check below my hero stats that where included. </p>
</td><td> <div style="display: flex; align-items: center;">
...
<table>
  <tr><td> <div style="display: flex; align-items: center;">
  <img src="images_rally_guide/diana_stats.PNG" width="1000" />
</td><td> <div style="display: flex; align-items: center;">
  <img src="images_rally_guide/petra_stats.PNG" width="1000" />
</td><td><p>The stats that will count for rallies are always only the "Expedition" stats. You can forget about the "Conquest" stats, those are only used in Arena and Conquest Battles. Those stats already account for the gear that is equipped in the hero.</p>
</td></tr>
</table>
